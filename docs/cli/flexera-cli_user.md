...
* [flexera-cli user create](flexera-cli_user_create.md)	 - Create and affiliate a user to an org
* [flexera-cli user delete](flexera-cli_user_delete.md)	 - Delete user
