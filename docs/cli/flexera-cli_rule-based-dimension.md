## flexera-cli rule-based-dimension

Rule-Based Dimension operations (generated from the unified OpenAPI spec)

### Options

```
  -h, --help   help for rule-based-dimension
```
...
* [flexera-cli rule-based-dimension bulk](flexera-cli_rule-based-dimension_bulk.md)	 - Create or update rule-based dimensions from JSON input
