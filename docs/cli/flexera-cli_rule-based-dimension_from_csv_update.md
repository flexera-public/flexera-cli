## flexera-cli rule-based-dimension from_csv update

Create or update rule-based dimensions from CSV (update)

```
flexera-cli rule-based-dimension from_csv update [flags]
```
