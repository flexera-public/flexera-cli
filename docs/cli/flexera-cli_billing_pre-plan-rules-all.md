## flexera-cli billing pre-plan-rules-all

Create an adjustment rule that runs before all plans

```
flexera-cli billing pre-plan-rules-all [flags]
```
...
```
  ...
  -h, --help               help for pre-plan-rules-all
