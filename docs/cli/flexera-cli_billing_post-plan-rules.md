## flexera-cli billing post-plan-rules

Overwrite an adjustment rule that runs after all plans

```
flexera-cli billing post-plan-rules [flags]
```
...
```
  ...
  -h, --help               help for post-plan-rules
