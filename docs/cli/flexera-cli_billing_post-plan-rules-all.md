## flexera-cli billing post-plan-rules-all

Create an adjustment rule that runs after all plans

```
flexera-cli billing post-plan-rules-all [flags]
```
...
```
  ...
  -h, --help               help for post-plan-rules-all
